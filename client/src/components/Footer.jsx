        ...
        <div className="footer__grid">
          <div className="footer__brand">
            ...
            <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
              <a href="https://www.instagram.com/sracholidays?igsh=dGwycnU3MjIyYjg5" target="_blank" rel="noreferrer" style={{ color: '#888', transition: 'color 0.3s' }}
          ...
          <div className="footer__col">
            ...
            <ul>
              ...
              <li><Link to="/tours?category=Getaway">Getaways</Link></li>
            </ul>
          </div>
